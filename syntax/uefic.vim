...
" uefic extensions
" 2.1.1 UEFI Images Table 4. UEFI Image Memory Types {{{
syn keyword	ueficImageMemoryType	EFI_IMAGE_SUSBSYTEM_EFI_APPLICATION EFI_IMAGE_SUBSYSTEM_EFI_BOOT_SERVICE_DRIVER EFI_IMAGE_SUBSYSTEM_EFI_RUNTIME_DRIVER
" }}}

" 2.3.1 Data Types  {{{1
" Table 6. Common UEFI Data Types {{{2
...
" }}}2
" Table 7. Modifiers for Common UEFI Data Types {{{2
syn keyword	ueficModifier		IN OUT OPTIONAL CONST EFIAPI
" }}}2
syn keyword	ueficBoolean		TRUE FALSE
" }}}1

" 2.3.6.1 Memory types Table 8. Map: EFI memory types to AArch64 memory types {{{
syn keyword ueficAArch64MemoryType	EFI_MEMORY_UC EFI_MEMORY_WC EFI_MEMORY_WT EFI_MEMORY_WB
" }}}

" Table 9. UEFI Protocols {{{
...
" Table 10. Required UEFI Implementation Elements {{{
...
" }}}
" Table 235. EFI_STATUS Success Codes {{{
syn keyword	ueficEfiStatusSuccess	EFI_SUCCESS
" }}}
" Table 236. EFI_STATUS Error Codes {{{
...
" }}}
" Table 237. EFI_STATUS Warning Codes {{{
syn keyword	ueficEfiStatusWarning	EFI_WARN_UNKNOWN_GLYPH EFI_WARN_DELETE_FAILURE EFI_WARN_WRITE_FAILURE EFI_WARN_BUFFER_TOO_SMALL EFI_WARN_STALE_DATA EFI_WARN_FILE_SYSTEM
" }}}
